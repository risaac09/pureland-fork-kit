...
Use this annex when the practice you are assessing includes a model, an automated decision, a generative interface, a recommender, a transcription service, or an agent.
