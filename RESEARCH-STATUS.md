...
| Separating who is in the relation from who holds the camera and the edit catches asymmetries a headcount taxonomy alone hides, such as a handoff that keeps edit authority with the absent party | PureLand hypothesis | Camera-based field applications that record both axes, and at least one case where the two readings disagree and the holder reading proves the more useful one |
| Returning raw material to a participant by default, rather than only the finished artifact, gives back the encounter rather than the maker's reading of it | PureLand hypothesis | Applications that record what the participant chose when offered raw, edited, both, or none, and whether the people who took raw material report it as useful or as a burden and an exposure they did not want |
| An interval agreed before recording, between the last recording and the first edit decision, protects the participant rather than only reassuring the maker | PureLand hypothesis | A comparison between makers who cut immediately and makers who wait, measured on participant recognition and approval at review, plus a burden record for who pays for the delay |
