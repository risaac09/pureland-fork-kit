...
| Field | Record |
|---|---|
| Tool | OpenAI Codex for the draft; model variant and effort are not recorded in the draft's own record. Claude Fable 5.1 in Claude Code for the reconciliation, the review passes, and preparing the pull request |
