...
2. [The PureLand method](METHOD.md): the repeatable inquiry, six steps from Scope to Report.
...
A person and a model read this repository differently. [The method](METHOD.md) is the human lane, run, and [llms.txt](llms.txt) is the agent lane, addressed. The [crosswalk](CROSSWALK.md) sets the two against each other element by element and holds the reason the difference is named rather than left to chance.
