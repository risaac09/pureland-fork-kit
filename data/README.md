...
CI installs `requirements.txt` before running `scripts/check_repo.py`. The checker fails with an explicit message when the package is absent. It never skips schema validation.
