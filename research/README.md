...
No public research packet has been released. The repository contains a provenance record, an AI-assistance record, the [research-status ledger](../RESEARCH-STATUS.md), the current [results summary](../RESULTS.md), and one worked field example, [FT-001](field-tests/ft-001-alchemy.md), the journey walked on Alchemy from the maintainer's side. FT-001 is not independent and is not a research packet.
