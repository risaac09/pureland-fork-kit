...
- participant or client material;
- consent and relationship records;
- personal notes;
- protected community knowledge;
- copied third-party material that cannot be relicensed;
- credentials or identifying data; or
- unreviewed allegations.

## Current status

No public research packet has been released. Current evidence consists of the [research-status ledger](../RESEARCH-STATUS.md), the [field-trial ledger](../FIELD-TRIALS.md), and one maintainer-side partial dry run, [FT-001](field-tests/ft-001-alchemy.md). FT-001 is AI-assisted, not independent, and not a research packet. The repository also contains a provenance record and an AI-assistance record.
